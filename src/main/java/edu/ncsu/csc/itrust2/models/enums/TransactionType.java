 ...
 * of it that can be displayed to the user. Also stores whether the event is patient-visible.
 *
 * <p>As new functionality is added to iTrust2, add in new TransactionType codes representing the
 * event.
 *
...
public enum TransactionType {
    ...
    CREATE_MISSING_EMAIL_LOG(
            1404, "Email notification could not be sent due to missing email address", true),
    ...
    EDIT_BLOOD_SUGAR_DIARY(
            2505, "Patient edits their blood sugar diary entry for the present date.", true),
    /** Patient views their own blood sugar limits */
    VIEW_BLOOD_SUGAR_LIMITS_PATIENT(
            2506, "Patient views their blood sugar limits set by their HCP.", true),
    ...
    FIND_EXPERTS_HCP(
            2601, "HCP viewed experts by location and specialty for patient referral.", false),
     ...
     * @param patientViewable Whether this logged event can be viewed by the patient involved
     */
