...
public class APIHospitalTest {
    ...
    /** Tests getting a non existent hospital and ensures that the correct status is returned. */
    @Test
    ...
    public void testHospitalAPI() throws Exception {
        ...
        mvc.perform(get("/api/v1/hospitals/iTrust Test Hospital 2"))
        ...
        mvc.perform(
                        put("/api/v1/hospitals/iTrust Test Hospital 2")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(TestUtils.asJsonString(hospital)))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE));
        ...
        mvc.perform(
                        put("/api/v1/hospitals/iTrust Test Hospital 3")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content(TestUtils.asJsonString(hospital)))
