...
public class PatientControllerTest {
    ...
    public void testPatientController() throws Exception {
        String content =
            mvc.perform(get("/patient/manageAppointmentRequest"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
        // content =
        //     mvc.perform(get("/patient/officeVisit/viewOfficeVisits"))
        //             .andReturn()
        //             .getResponse()
        //             .getContentAsString();
        // System.out.println(content);
        content =
            mvc.perform(get("/patient/officeVisit/viewPrescriptions"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
        content =
            mvc.perform(get("/patient/index"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
        content =
            mvc.perform(get("/patient/editDemographics"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
        content =
            mvc.perform(get("/patient/officeVisit/viewDiagnoses"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
