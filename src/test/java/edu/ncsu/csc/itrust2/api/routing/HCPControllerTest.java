...
public class HCPControllerTest {
    ...
    public void testHCPController() throws Exception {
        String content =
            mvc.perform(get("/hcp/index"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
        content =
            mvc.perform(get("/hcp/editPatientDemographics"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
        // content =
        //     mvc.perform(get("/hcp/editPrescriptions"))
        //             .andReturn()
        //             .getResponse()
        //             .getContentAsString();
        // System.out.println(content);
        content =
            mvc.perform(get("/hcp/appointmentRequests"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
        content =
            mvc.perform(get("/hcp/documentOfficeVisit"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
        content =
            mvc.perform(get("/hcp/EmergencyHealthRecords"))
                    .andReturn()
                    .getResponse()
                    .getContentAsString();
        System.out.println(content);
